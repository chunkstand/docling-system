"""Add claim support replay fixture promotion governance events.

Revision ID: 0064_claim_replay_fixtures
Revises: 0063_claim_replay_escalations
...
revision: str = "0064_claim_replay_fixtures"
down_revision: str | Sequence[str] | None = "0063_claim_replay_escalations"
