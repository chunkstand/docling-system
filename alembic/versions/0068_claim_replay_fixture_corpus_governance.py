"""Govern replay alert fixture corpus snapshots.

Revision ID: 0068_claim_replay_corpus_gov
Revises: 0067_claim_replay_fixture_corpus
...
revision: str = "0068_claim_replay_corpus_gov"
down_revision: str | Sequence[str] | None = "0067_claim_replay_fixture_corpus"
...
def upgrade() -> None:
    ...
    op.add_column(
        "claim_support_replay_alert_fixture_corpus_snapshots",
        sa.Column("governance_receipt_sha256", sa.Text(), nullable=True),
    )
    op.create_foreign_key(
        "fk_cs_replay_fixture_corpus_snapshot_governance_event",
        "claim_support_replay_alert_fixture_corpus_snapshots",
        "semantic_governance_events",
    ...
    op.create_foreign_key(
        "fk_cs_replay_fixture_corpus_snapshot_governance_artifact",
        "claim_support_replay_alert_fixture_corpus_snapshots",
