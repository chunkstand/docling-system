"""Add claim support replay waiver closure governance events.

Revision ID: 0065_claim_waiver_closures
Revises: 0064_claim_replay_fixtures
...
revision: str = "0065_claim_waiver_closures"
down_revision: str | Sequence[str] | None = "0064_claim_replay_fixtures"
