...
- The later 2026-05-19 registry-alignment sweep deploys the stale reduced-root
  ...
  counts are now `open=12`, `verified=8`, and `deployed=40`, the routed queue
  remains empty, hygiene still reports no regressions or inherited budget
  debt, and the fresh architecture probe still reports `0` Python cycles
  without introducing a new adjacent governance hotspot.
