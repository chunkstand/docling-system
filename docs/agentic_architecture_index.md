...
- `docs/evaluations_service_boundary_milestone_plan.md`: active stacked follow-on after the search orchestration and claim-support packets. Milestone 0 is resolved locally after closeout commits `dae5e4f` and `3d7d090`, and Milestone 1 is now the next implementation gate for the evaluation service boundary split under `IC-BF180637814C` / `app/services/evaluations.py`.
