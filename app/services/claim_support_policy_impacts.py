...
from app.services import claim_support_replay_alert_promotions as _replay_alert_promotions
...
claim_support_policy_change_impact_fixture_candidates = (
    _replay_alert_promotions.claim_support_policy_change_impact_fixture_candidates
)
claim_support_replay_alert_fixture_coverage_summary = (
    _replay_alert_promotions.claim_support_replay_alert_fixture_coverage_summary
)
latest_claim_support_replay_alert_fixture_rows = (
    _replay_alert_promotions.latest_claim_support_replay_alert_fixture_rows
)
promote_claim_support_policy_change_impact_fixture_candidates = (
    _replay_alert_promotions.promote_claim_support_policy_change_impact_fixture_candidates
)
