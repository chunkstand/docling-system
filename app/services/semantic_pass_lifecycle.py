...
import app.services.semantic_pass_artifacts as artifact_owner
...
SEMANTIC_ARTIFACT_SCHEMA_NAME = artifact_owner.SEMANTIC_ARTIFACT_SCHEMA_NAME
SEMANTIC_ARTIFACT_SCHEMA_VERSION = artifact_owner.SEMANTIC_ARTIFACT_SCHEMA_VERSION
SEMANTIC_EXTRACTOR_VERSION = artifact_owner.SEMANTIC_EXTRACTOR_VERSION
SEMANTIC_MATCH_STRATEGY = artifact_owner.SEMANTIC_MATCH_STRATEGY
SEMANTIC_EVAL_VERSION = artifact_owner.SEMANTIC_EVAL_VERSION
_semantic_artifact_payload = artifact_owner.semantic_artifact_payload
_persist_semantic_artifacts = artifact_owner.persist_semantic_artifacts
...
review_owner.configure_semantic_pass_review_projection(
    load_registry=get_semantic_registry,
    persist_artifacts=_persist_semantic_artifacts,
)
...
def execute_semantic_pass(
    ...
    *,
    ...
    try:
        ...
        concept_review_overlays = review_owner.latest_concept_review_overlays(
            session,
            document.id,
            registry.registry_version,
        )
        category_review_overlays = review_owner.latest_category_review_overlays(
            session,
            document.id,
            registry.registry_version,
        )
        ...
        session.commit()
        return failed_pass
latest_category_review_overlays = review_owner.latest_category_review_overlays
latest_concept_review_overlays = review_owner.latest_concept_review_overlays
review_active_semantic_assertion = review_owner.review_active_semantic_assertion
review_active_semantic_assertion_category_binding = (
    review_owner.review_active_semantic_assertion_category_binding
)
