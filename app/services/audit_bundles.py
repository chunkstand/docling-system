...
_payload_claim_support_replay_alert_corpus_lineage_complete = (
    _audit_bundle_replay_alert_corpus.payload_claim_support_replay_alert_corpus_lineage_complete
)
_payload_requires_claim_support_replay_alert_corpus_lineage = (
    _audit_bundle_replay_alert_corpus.payload_requires_claim_support_replay_alert_corpus_lineage
)
...
_training_run_claim_support_replay_alert_corpus_lineage_payload = (
    _audit_bundle_replay_alert_corpus.training_run_claim_support_replay_alert_corpus_lineage_payload
)
