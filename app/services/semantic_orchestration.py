...
def build_semantic_success_metrics(
    ...
    return [
        ...
        },
        {
            ...
            "summary": "The system owns durable semantic context instead of reconstructing it ad hoc.",
            "details": {
    ...
    *,
            ...
            issues.append(
                {
                    ...
                    "assertion_id": None,
                    "binding_id": None,
                    "summary": f"Expected concept {concept_key} is missing from the active semantic pass.",
                    "details": {
                        "minimum_evidence_count": raw_expectation.get("minimum_evidence_count"),
                        "required_source_types": list(raw_expectation.get("required_source_types") or []),
                        "expected_category_keys": list(raw_expectation.get("expected_category_keys") or []),
                        "observed_evidence_count": raw_expectation.get("observed_evidence_count"),
                        "observed_source_types": list(raw_expectation.get("observed_source_types") or []),
                        "observed_category_keys": list(raw_expectation.get("observed_category_keys") or []),
                    },
                    "evidence_refs": [],
                    ...
                    "registry_update_hints": [
                        {
                            ...
                            "reason": "The evaluation corpus expects this concept-category binding.",
                        }
        ...
        issues.append(
            {
                ...
                "concept_key": concept_key,
                "category_key": None,
                "assertion_id": getattr(assertions_by_concept.get(concept_key), "assertion_id", None),
                "binding_id": None,
                "summary": f"Concept {concept_key} was added relative to the baseline semantic pass.",
        ...
        issues.append(
            {
                ...
                "assertion_id": None,
                "binding_id": None,
                "summary": f"Concept {concept_key} disappeared relative to the baseline semantic pass.",
                "details": {"continuity_reason": continuity_summary.get("reason")},
                "evidence_refs": [],
                "registry_update_hints": [],
            }
    ...
    if has_registry_hints:
        recommendation = {
            ...
            "confidence": "high",
            "summary": "The semantic gap report contains additive registry updates that can be drafted safely.",
        }
        followups = [
            {
                "followup_type": "draft_registry_update",
                "priority": "high",
                "summary": "Draft an additive semantic registry update from the triaged gap report.",
        ...
        recommendation = {
            ...
            "confidence": "medium",
            "summary": "Review-status regressions need operator attention before changing the registry.",
        }
        followups = [
            {
                "followup_type": "review_assertion",
                "priority": "high",
                "summary": "Inspect semantic review regressions and confirm whether they are intentional.",
        ...
        recommendation = {
            ...
            "confidence": "high",
            "summary": "The active semantic pass is stable and meets the current semantic expectations.",
        }
        followups = [
            {
        ...
        recommendation = {
            ...
            "confidence": "medium",
            "summary": "The semantic pass needs operator review before any registry change is proposed.",
        }
        followups = [
            {
                "followup_type": "review_assertion",
                "priority": "medium",
                "summary": "Review the semantic evidence gaps and decide whether registry work is warranted.",
                "target_task_type": None,
                "details": {"issue_count": issue_count},
            }
        ]
    ...
    *,
    ...
    for operation in operations:
        ...
        if operation["operation_type"] == "add_alias":
            ...
            raise ValueError(f"Unsupported semantic registry operation: {operation['operation_type']}")
...
def draft_semantic_registry_update(
    ...
    *,
    ...
    base_registry = get_semantic_registry()
    base_registry_payload = load_semantic_registry_payload()
    next_version = proposed_registry_version or _next_registry_version(base_registry.registry_version)
    ...
    success_metrics = [
        ...
        },
        {
            ...
            "summary": "The draft is encoded as typed operations plus a concrete effective registry snapshot.",
        ...
        },
        {
            ...
            "summary": "Every proposed registry edit is tied back to a document-scoped semantic gap report.",
            "details": {
        ...
        },
        {
            ...
            "summary": "The draft compresses a larger semantic gap report into a small set of actionable operations.",
            "details": {
                "operation_count": len(operations),
    ...
    *,
    ...
    return [
        ...
        },
        {
            ...
            "summary": "Verification emits per-document typed deltas tied to typed registry operations.",
        ...
        },
        {
            ...
            "stakeholder": "Ronacher",
            "passed": True,
            "summary": "Verification stays read-only and compares previews without mutating the live registry.",
            "details": {"live_mutation_performed": False},
        },
        {
            "metric_key": "owned_context_verification",
            "stakeholder": "Jones",
            "passed": all(delta.get("evaluation_fixture_name") is not None for delta in document_deltas),
            "summary": "Every verification delta remains grounded in a document and evaluation fixture.",
            "details": {},
        },
        {
    ...
    *,
    ...
    return [
        ...
        },
        {
            ...
            "summary": "The live apply step publishes typed operations rather than an opaque file diff.",
        ...
        },
        {
            ...
            "summary": "The published registry state remains attributable to specific typed operations.",
            "details": {},
        },
        {
