...
from app.services.agent_actions.report_context_pack import (
    evaluate_document_generation_context_pack_executor as _evaluate_context_pack_executor,
)
from app.services.agent_actions.report_drafting import (
    draft_technical_report_executor as _draft_technical_report_executor,
)
from app.services.agent_actions.report_drafting import (
    verify_technical_report_executor as _verify_technical_report_executor,
)
from app.services.agent_actions.report_evidence import (
    build_report_evidence_cards_executor as _build_report_evidence_cards_executor,
)
from app.services.agent_actions.report_evidence import (
    prepare_report_agent_harness_executor as _prepare_report_agent_harness_executor,
)
from app.services.agent_actions.report_planning import (
    plan_technical_report_executor as _plan_technical_report_executor,
)
...
_ACTION_REGISTRY: dict[str, AgentTaskActionDefinition] = {
    ...
    "evaluate_document_generation_context_pack": AgentTaskActionDefinition(
        ...
        executor=_evaluate_context_pack_executor,
