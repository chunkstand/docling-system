...
class ProvenanceGraphState:
    ...
    def new(cls) -> ProvenanceGraphState:
        return cls(
            agents={
                "docling:agent/docling-system": {"prov:type": "prov:SoftwareAgent", "prov:label": "Docling System"},  # noqa: E501
                "docling:agent/technical-report-gate": {"prov:type": "prov:SoftwareAgent", "prov:label": "Technical report verification gate"},  # noqa: E501
                "docling:agent/context-pack-gate": {"prov:type": "prov:SoftwareAgent", "prov:label": "Document generation context-pack gate"},  # noqa: E501
            }
        )
