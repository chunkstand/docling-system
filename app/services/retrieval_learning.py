...
from app.services import (
    retrieval_learning_artifacts as _retrieval_learning_artifacts,
)
from app.services import (
    retrieval_learning_candidates as _retrieval_learning_candidates,
)
from app.services import (
    retrieval_learning_replay_alert_sources as _replay_alert_sources,
)
...
_claim_support_expected_judgment = _replay_alert_sources.claim_support_expected_judgment
