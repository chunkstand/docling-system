...
def claim_support_policy_change_impact_alerts(*args, **kwargs):
    return _lazy_service_attr(
...
def record_claim_support_policy_change_impact_alert_escalations(*args, **kwargs):
    return _lazy_service_attr(
        "app.services.claim_support_policy_impacts",
...
def claim_support_policy_change_impact_fixture_candidates(*args, **kwargs):
    return _lazy_service_attr(
        "app.services.claim_support_policy_impacts",
...
def promote_claim_support_policy_change_impact_fixture_candidates(*args, **kwargs):
    return _lazy_service_attr(
        "app.services.claim_support_policy_impacts",
...
def run_claim_support_replay_fixture_candidates() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Report or promote claim-support replay alert fixture candidates."
        )
    )
    parser.add_argument("--policy-name", default=None)
    parser.add_argument("--stale-after-hours", type=int, default=24)
