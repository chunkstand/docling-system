...
uv run docling-system-agent-task-create verify_claim_support_calibration_policy --input-json '{"target_task_id":"<policy_draft_task_id>","fixture_set_name":"default_claim_support_v1","fixture_set_version":"v1"}'
